...
void Dialog::addSpacer(const SpacerTypes type) {
    switch (type) {
        case SPACER_BIG: dialogstr.append("add_spacer|big|\n"); break;
        case SPACER_SMALL: dialogstr.append("add_spacer|small|\n"); break;
        default: break;
    }
}
...
void Dialog::addLabelWithIcon(const string text, const int tileid, const LabelStyles type) {
    switch (type) {
        case LABEL_BIG: dialogstr.append("add_label_with_icon|big|" + text + "|left|" + to_string(tileid) + "|\n"); break;
        case LABEL_SMALL: dialogstr.append("add_label_with_icon|small|" + text + "|left|" + to_string(tileid) + "|\n"); break;
        default: break;
    }
}
...
void Dialog::addCheckbox(const string checkboxname, const string string, bool checked) {
    switch (checked) {
        case 1: dialogstr.append("add_checkbox|" + checkboxname + "|" + string + "|1|\n"); break;
        case 0: dialogstr.append("add_checkbox|" + checkboxname + "|" + string + "|0|\n"); break;
        default: break;
    }
}
